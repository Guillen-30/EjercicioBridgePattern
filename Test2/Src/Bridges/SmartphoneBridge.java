...
public class SmartphoneBridge implements DeviceBridge {
    ...
    public void testDevice() {
        ...
        System.out.println("Hey siri!! Pon el volumen de "+device.getName()+" en "+ numRandom);
        System.out.println("Volumen del dispositivo "+device.getName()+ " en "+ numRandom );
        System.out.println("Hey siri!! Reproduce netflix en "+device.getName());
