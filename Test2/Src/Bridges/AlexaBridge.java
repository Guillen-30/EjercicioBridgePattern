...
public class AlexaBridge implements DeviceBridge {
    ...
    public void testDevice() {
        ...
        System.out.println("Alexa!! Pon el volumen de "+device.getName()+" en "+ numRandom);
        System.out.println("Volumen del dispositivo "+device.getName()+ " en "+ numRandom );
        System.out.println("Alexa!! Reproduce netflix en "+device.getName());
